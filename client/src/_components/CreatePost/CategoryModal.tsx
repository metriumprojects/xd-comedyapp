    ...
    return (
      <TouchableOpacity
        style={{
          ...
          backgroundColor: isSelected ? '#FFF8F0' : COLORS.surface,
          borderRadius: 12,
          marginBottom: 8,
          borderWidth: 1,
          borderColor: isSelected ? '#FFE0B2' : COLORS.inputBg
        }}
        onPress={() => {
          hapticLight();
          if (isSelected) {
        ...
        activeOpacity={0.7}
      >
        <Text style={{ fontSize: 15, fontWeight: isSelected ? '600' : '400', color: isSelected ? COLORS.primary : COLORS.textPrimary, flex: 1 }}>
          {item.name}
        </Text>
        <Ionicons 
          name={isSelected ? "checkbox" : "square-outline"} 
          size={22} 
          color={isSelected ? COLORS.primary : "#B0B0B0"} 
        />
      </TouchableOpacity>
    );
  };
        ...
        <View style={{ flex: 1, backgroundColor: 'rgba(0,0,0,0.6)', justifyContent: 'flex-end' }}>
          ...
          <View style={{
            ...
            >
              ...
              <Text style={{ fontWeight: '500', fontSize: 16, marginBottom: 8, color: COLORS.black, textAlign: 'center' }}>Add a category</Text>
