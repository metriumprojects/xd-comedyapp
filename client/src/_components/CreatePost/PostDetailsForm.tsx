      ...
      <View style={{ paddingHorizontal: 15 }}>
        ...
        <TouchableOpacity style={{ flexDirection: 'row', alignItems: 'center', paddingVertical: 14 }} onPress={onOpenVisibility}>
          ...
          <View style={{ flex: 1 }}>
            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
              <View style={{ 
                backgroundColor: visibility === 'Everyone' ? '#f5f5f5' : '#E3F2FD', 
                paddingHorizontal: 12, 
                paddingVertical: 6, 
                borderRadius: 20, 
                flexDirection: 'row', 
                alignItems: 'center',
                borderWidth: 1,
                borderColor: visibility === 'Everyone' ? '#e0e0e0' : '#90CAF9',
                maxWidth: '95%'
              }}>
                <Feather 
                  name={visibility === 'Everyone' ? 'globe' : 'lock'} 
                  size={12} 
                  color={visibility === 'Everyone' ? '#666' : '#1976D2'} 
                  style={{ marginRight: 6 }} 
                />
                <Text style={{ 
                  color: visibility === 'Everyone' ? '#333' : '#1976D2', 
                  fontSize: 14, 
